...
public class JarvisMarchHull {
	...
	private final ArrayList<Point2D> hull = new ArrayList<>();;
	 ...
	 */
	public JarvisMarchHull(Point2D[] pts) {
		this.points = pts;
	 ...
	 *
	 * @return	JarvisMarchHull.TURN_RIGHT, JarvisMarchHull.TURN_NONE, or JarvisMarchHull.TURN_LEFT
	 */
